...
int lua_cocos2dx_studio_MovementData_getDuration(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::MovementData* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_MovementData_getDuration'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_MovementData_getDuration'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccs.MovementData:getDuration",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_MovementData_getDuration'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_studio_MovementData(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"MovementData");
        ...
        tolua_function(tolua_S,"getDuration",lua_cocos2dx_studio_MovementData_getDuration);
...
int lua_cocos2dx_studio_ArmatureAnimation_GetLastMovementID(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ArmatureAnimation_GetLastMovementID'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_ArmatureAnimation_GetLastMovementID'", nullptr);
            return 0;
        }
        const std::string& ret = cobj->GetLastMovementID();
        tolua_pushcppstring(tolua_S,ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccs.ArmatureAnimation:GetLastMovementID",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ArmatureAnimation_GetLastMovementID'.",&tolua_err);
#endif
...
int lua_cocos2dx_studio_ArmatureAnimation_getCurrentMovementID(lua_State* tolua_S)
{
    ...
    if (argc == 0) 
    {
        ...
        const std::string& ret = cobj->getCurrentMovementID();
        tolua_pushcppstring(tolua_S,ret);
        return 1;
    }
...
int lua_register_cocos2dx_studio_ArmatureAnimation(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ArmatureAnimation");
        ...
        tolua_function(tolua_S,"GetLastMovementID",lua_cocos2dx_studio_ArmatureAnimation_GetLastMovementID);
...
int lua_cocos2dx_studio_ArmatureDataManager_removeAllArmatureFileInfo(lua_State* tolua_S)
{
    int argc = 0;
    cocostudio::ArmatureDataManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_studio_ArmatureDataManager_removeAllArmatureFileInfo'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_studio_ArmatureDataManager_removeAllArmatureFileInfo'", nullptr);
            return 0;
        }
        cobj->removeAllArmatureFileInfo();
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccs.ArmatureDataManager:removeAllArmatureFileInfo",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_studio_ArmatureDataManager_removeAllArmatureFileInfo'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_studio_ArmatureDataManager(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ArmatureDataManager");
        ...
        tolua_function(tolua_S,"removeAllArmatureFileInfo",lua_cocos2dx_studio_ArmatureDataManager_removeAllArmatureFileInfo);
