...
int lua_cocos2dx_experimental_webview_WebView_setOnJSCallback(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::WebView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_setOnJSCallback'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_setOnJSCallback'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_setOnJSCallback'.",&tolua_err);
#endif
...
int lua_cocos2dx_experimental_webview_WebView_getOnShouldStartLoading(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::WebView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_getOnShouldStartLoading'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_getOnShouldStartLoading'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_getOnShouldStartLoading'.",&tolua_err);
#endif
...
int lua_cocos2dx_experimental_webview_WebView_setOnDidFinishLoading(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::WebView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_setOnDidFinishLoading'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_setOnDidFinishLoading'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_setOnDidFinishLoading'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_experimental_webview_WebView_setOnDidFailLoading(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::WebView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_setOnDidFailLoading'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_setOnDidFailLoading'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_setOnDidFailLoading'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_experimental_webview_WebView_getOnDidFinishLoading(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::WebView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_getOnDidFinishLoading'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_getOnDidFinishLoading'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_getOnDidFinishLoading'.",&tolua_err);
#endif

    return 0;
}
int lua_cocos2dx_experimental_webview_WebView_getOnDidFailLoading(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::WebView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_getOnDidFailLoading'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_getOnDidFailLoading'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_getOnDidFailLoading'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_experimental_webview_WebView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"WebView");
        ...
        tolua_function(tolua_S,"setOnJSCallback",lua_cocos2dx_experimental_webview_WebView_setOnJSCallback);
        ...
        tolua_function(tolua_S,"getOnShouldStartLoading",lua_cocos2dx_experimental_webview_WebView_getOnShouldStartLoading);
        ...
        tolua_function(tolua_S,"setOnDidFinishLoading",lua_cocos2dx_experimental_webview_WebView_setOnDidFinishLoading);
        tolua_function(tolua_S,"setOnDidFailLoading",lua_cocos2dx_experimental_webview_WebView_setOnDidFailLoading);
        tolua_function(tolua_S,"getOnDidFinishLoading",lua_cocos2dx_experimental_webview_WebView_getOnDidFinishLoading);
        tolua_function(tolua_S,"getOnDidFailLoading",lua_cocos2dx_experimental_webview_WebView_getOnDidFailLoading);
