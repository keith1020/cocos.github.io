...
--------------------------------
-- 
-- @function [parent=#FileUtils] mkDir 
-- @param self
-- @param #char path
...
--------------------------------
-- 
-- @function [parent=#FileUtils] removeCachedEntries 
-- @param self
-- @param #string filename
...
--------------------------------
-- 
-- @function [parent=#FileUtils] getResRootPath 
-- @param self
-- @return string#string ret (return value: string)
...
--------------------------------
-- unzip file to dir add by jonyu<br>
-- param[in]  filename The resource file name which contains the relative path of the zip file.<br>
-- param[in]  where the file to unzip
-- @function [parent=#FileUtils] unZipFile 
-- @param self
