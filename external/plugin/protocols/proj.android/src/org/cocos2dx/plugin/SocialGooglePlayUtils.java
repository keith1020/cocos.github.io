 ...
 */
public class SocialGooglePlayUtils {
 ...
 // request codes we use when invoking an external activity
    ...
    private final static int[] RES_IDS = {
            R.string.sign_in_failed, R.string.sign_in_failed,
            R.string.sign_in_failed, R.string.sign_in_failed
    };
    ...
    static String getString(Context ctx, int whichString) {
        ...
        try {
            ...
            ex.printStackTrace();
            Log.w(SocialGooglePlay.TAG, "*** GameHelper could not found resource id #" + resId + ". " +
