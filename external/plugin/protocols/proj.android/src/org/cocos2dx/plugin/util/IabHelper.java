...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        Intent i = getExplicitIapIntent();
        if( null == i ){
        	return;
        }
        mContext.bindService( i, mServiceConn, Context.BIND_AUTO_CREATE );
        /*
    ...
    public void launchPurchaseFlow(Activity act, String sku, int requestCode, OnIabPurchaseFinishedListener listener, String extraData) {
        ...
        try {
        	...
        	result = new IabResult(IABHELPER_REMOTE_EXCEPTION, "unkown exception");
            if (listener != null) listener.onIabPurchaseFinished(result, null);
        }
    }
