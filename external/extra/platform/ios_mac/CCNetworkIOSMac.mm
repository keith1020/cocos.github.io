...
{
    return [[ReachabilityIOSMac reachabilityForLocalWiFi] currentReachabilityStatus] == ReachableViaWiFi;
}

bool CCNetwork::isInternetConnectionAvailable(void)
{
    return [[ReachabilityIOSMac reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN;
}
